...
const Init = {
    QuizHard:[
        ...
        {   id:'3',
            question:'What is the time complexity of performing a linear search in an unsorted array?',
            opt1:'O(n)',
            opt2:'O(log n)',
            opt3:'O(n^2)',
            opt4:'O(1)',
        ...
        {   id:'5',
            question:'What is the output of the following code snippet?    Code:-  [  print(2 ** 3 ** 2) ]',
            opt1:'64',
            opt2:'512',
            opt3:'4096',
            opt4:'Syntax Error',
        ...
        {   id:'7',
            question:'What is the time complexity of a binary search algorithm in a sorted array of size n?',
            opt1:'O(n)',
            opt2:'O(log n)',
            opt3:'O(n log n)',
            opt4:'O(1)',
        ...
        {   id:'10',
            question:'Which is NOT a valid way to access elements in a dictionary in Python?',
            opt1:'dictionary[key]',
